    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make(__("description"), "description")->displayUsing(function(){
                return mb_convert_encoding(substr($this->description, 0,20)."...","UTF-8", "auto");

            })->asHtml()->required()->exceptOnForms(),
            ...
            Text::make(__("memo"), "memo")->displayUsing(function(){
                if($this->memo)
                    return mb_convert_encoding(substr($this->memo, 0,20)."...","UTF-8", "auto");
            ...
            Date::make(__("opened_at"), "opened_at")->required(),
            ...
            DateTime::make(__("created_at"), "created_at")->sortable()->exceptOnForms(),
