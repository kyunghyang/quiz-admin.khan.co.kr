...
class PointHistory extends Resource
{
    ...
    {
        return __("PointHistories");
    }


    public static function singularLabel()
    {
        return __("PointHistory");
    }

    public static $model = \App\Models\PointHistory::class;
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Number::make(__("point"), "point")->required(),
